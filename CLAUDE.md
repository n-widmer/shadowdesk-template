...
Live updates need your personal key. Until you have one, you're on the free starter set: it works, it just doesn't grow on its own. When you're ready to switch updates on, I'll send you two quick setup lines by email. Paste them in, reopen, and `/shadowdesk:update` keeps you current from then on.
